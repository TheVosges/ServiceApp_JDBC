...
@rem ##########################################################################
@rem
@rem  ServiceApp startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and SERVICE_APP_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVICE_APP_OPTS%  -classpath "%CLASSPATH%" ib.ServiceApp %*
...
:fail
rem Set variable SERVICE_APP_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%SERVICE_APP_EXIT_CONSOLE%" exit 1
exit /b 1
